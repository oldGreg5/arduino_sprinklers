...
void setup() {
	...
	delay(10);
	Blynk.begin(auth, wifi, "babilons", "thai0lai5");
...
void loop() {
	//tank is full
	if (analogRead(PIN_WATER_SENSOR) < 800 && tankFull == false) {
		lcd.print(0, 1, "                ");
		lcd.print(0, 1, "Tank full");
		digitalWrite(PIN_WELL_PUMP, HIGH);
		tankFull = true;
